...

{
    ...
    public void print() {
        if (operatorANDtoArray(statisticsCheckList)) {
            System.out.print("\nHigh Score ");
            for (int i = 0; i < numberofquizzes; i++) {System.out.print(highscores[i] + " ");}
            System.out.print("\nLow Score ");
            for (int i = 0; i < numberofquizzes; i++) {System.out.print(lowscores[i] + " ");}
            System.out.print("\nAverage ");
            for (int i = 0; i < numberofquizzes; i++) {System.out.print(avgscores[i] + " ");}
